...
```
The Tooth Growth data contains 60 records including the dose, supplement given and length of tooth in a guinea pig for an experiement. There are two types of supplement; VC and OJ each with 30 trials. There are 3 types of doses; 0.5, 1.0 and 2.0mg, each with 20 trials.
...
text1 = 'Dose of 1.0 always out performs does of 0.5 in stimulating tooth growth with 95% confidence'
text2 = 'Dose of 2.0 always out performs does of 0.5 in stimulating tooth growth with 95% confidence'
text3 = 'Dose of 2.0 always out performs does of 1.0 in stimulating tooth growth with 95% confidence'
```
Dose of 2.0 always out performs does of 1.0 in stimulating tooth growth with 95% confidence
